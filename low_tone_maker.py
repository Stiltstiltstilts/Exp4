...
SOUNDLEN = 1/2.5   
SOUNDFREQ = 166.6 # Hz... 333 is about Ab in pitch
...
tone = pygame.mixer.Sound(tone_accent.astype('int16')) #tone = pygame.mixer.Sound(final_output.astype('int16'))

# open new wave file objects
tonefile = wave.open('low8ve_tone.wav', 'w')
